...
public class SendWAPPush
{
	...
	public static void main(String[] args)
	{
		...
		{
			System.out.println("");
			System.out.println("IntelliSoftware Sample - Send WAP Push Message");
			System.out.println("");
			...
			String Title = GetParameter ("WAP Push Text");
			String Href = GetParameter ("WAP Push URL");
			...
			//Send message
			SendStatusCollection SendStatusList = objIntelliSMS.SendWapPushMessage ( ToList, Title, Href, "" );
